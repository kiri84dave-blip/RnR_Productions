...
#ara-canvas, #ara-webgl { width: 100%; height: 100%; display: block; position: absolute; inset: 0; }
#ara-webgl { display: none; }
.hud {
  position: absolute;
  left: 12px;
  bottom: 10px;
    ...
    def __init__(self, value: dict | None = None, **kwargs):
        super().__init__(
            ...
            or {
                ...
                "clothing": "dressed",
                "name": "Ara-Elizabeth",
                "glbUrl": "/ara-assets/KF1b_anim.glb",
            },
